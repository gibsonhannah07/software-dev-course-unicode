...
let lastCharCode = inputString2.charCodeAt(5);
let swappedString = String.fromCharCode(lastCharCode) + inputString2.slice(1, inputString2.length - 1) + String.fromCharCode(firstCharCode);
